...
function AuthContextProvider({ children }) {
  ...
  // const history = useHistory(); Herschrijven naar:
  ...
  function login(JWT) {
    ...
    // history.push('profile') niet meer nodig, omdat fetchUserData dat al doet.
  }
  ...
  async function fetchUserData(id, token, redirectUrl) {
    try {
      ...
      if (redirectUrl) {
        // history.push(redirectUrl); vervangen door:
